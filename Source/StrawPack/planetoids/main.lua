...
local mod = RegisterMod("planetoids", 1)
...
mod:AddCallback(ModCallbacks.MC_FAMILIAR_INIT, init_planetoid_sun, PlanetoidsSun.VARIANT)
...
mod:AddCallback(ModCallbacks.MC_FAMILIAR_UPDATE, update_planetoid_sun, PlanetoidsSun.VARIANT)
...
mod:AddCallback(ModCallbacks.MC_PRE_FAMILIAR_COLLISION, pre_sun_collision, PlanetoidsSun.VARIANT)
...
-- Called once after a Mechanical Fly (body type) familiar is initialized
mod:AddCallback(ModCallbacks.MC_FAMILIAR_INIT, init_planetoid_earth, PlanetoidsEarth.VARIANT)
...
mod:AddCallback(ModCallbacks.MC_FAMILIAR_UPDATE, update_planetoid_earth, PlanetoidsEarth.VARIANT)
...
mod:AddCallback(ModCallbacks.MC_PRE_FAMILIAR_COLLISION, pre_earth_collision, PlanetoidsEarth.VARIANT)
