...
local mod = RegisterMod("mechanical flies", 1)
...
-- Called once after a Mechanical Fly (tear type) familiar is initialized
mod:AddCallback(ModCallbacks.MC_FAMILIAR_INIT, init_mechfly_tear, MechflyTear.VARIANT)
...
-- Called every frame for each Mechanical Fly (tear type)
mod:AddCallback(ModCallbacks.MC_FAMILIAR_UPDATE, update_mechfly_tear, MechflyTear.VARIANT)
...
mod:AddCallback(ModCallbacks.MC_FAMILIAR_INIT, init_mechfly_body, MechflyBody.VARIANT)
...
mod:AddCallback(ModCallbacks.MC_FAMILIAR_UPDATE, update_mechfly_body, MechflyBody.VARIANT)
