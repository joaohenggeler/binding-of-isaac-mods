...
return {
	ID = MiniMaw.COLLECTIBLE_MINI_MAW,
	MINI_MAW_VARIANT = MiniMaw.VARIANT,
	init_mini_maw = init_mini_maw,
	update_mini_maw = update_mini_maw,
	pre_mini_maw_collision = pre_mini_maw_collision,
