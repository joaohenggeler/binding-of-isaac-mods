...
local function update_moldy_cheese(mod, player)
...
local function post_game_started(mod, from_save)
...
local function pre_game_exit(mod, should_save)
	if should_save then
		mod:SaveData(tostring(moldy_cheese_flag))
	end
end
...
return {
	ID = MoldyCheese.COLLECTIBLE_MOLDY_CHEESE,
	update_moldy_cheese = update_moldy_cheese,
	hit_moldy_cheese = hit_moldy_cheese,
	on_new_level = on_new_level,
	update_cache = update_cache,
	post_game_started = post_game_started,
	pre_game_exit = pre_game_exit
}